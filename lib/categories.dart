...
import 'package:responsinurul/ListCategory.dart';
...
class _KategoriState extends State<Kategori> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.purpleAccent[200], // Background color: Grey
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: Card(
              ...
              color: Colors.indigoAccent, // Card background color: White
              child: Column(
